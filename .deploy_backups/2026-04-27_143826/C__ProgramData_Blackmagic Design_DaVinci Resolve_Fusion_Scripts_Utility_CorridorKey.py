# Last modified: 2026-04-26 | Change: removed duplicate Mask Margin + Soften sliders from docked panel (they live only in the live preview viewer now); cleaned up dead handlers and helpers; get_settings defaults sam2_margin/soften to 0 — _merge_live_params pulls actual values from viewer's live_params.json | Full history: git log
