# Last modified: 2026-04-26 | Change: show_preview_window writes NN keyed_rgb (clean FG) to fg.png instead of raw orig_bgr — fixes purple soft-edge halo when MARGIN/SOFTEN expands matte into former greenscreen area; matches AE viewer behavior | Full history: git log
...
def get_settings():
    return {
        ...
        "sam2_margin": 0.0,   # viewer-owned; overridden by _merge_live_params
        "sam2_soften": 0.0,   # viewer-owned; overridden by _merge_live_params
    }
